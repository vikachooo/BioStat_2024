...
Точный критерий Фишера по сути похож на тест хи-квадрат, но он используется для маленьких выборок и когда есть ожидаемые значения менее 5 наблюдений на клетку таблицы.
